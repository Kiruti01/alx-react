...
(() => {
  var t = {
      ...
      568: (t, e, n) => {
        "use strict";
        n.d(e, { Z: () => r });
        const r = n.p + "d88e2b6551683f9cfb05f9b8f83860a8.jpg";
      },
      755: function (t, e) {
        var n;
        !(function (e, n) {
  ...
  (n.n = (t) => {
    ...
    (() => {
      ...
      const l = n(755),
        p = n(486);
      l("body").append("<p>Holberton Dashboard</p>"),
        l("body").append("<p>Dashboard data for the students</p>"),
        l("body").append("<button>Click here to get started</button>"),
        l("body").append('<p id="count"></p>'),
        l("body").append("<p>Copyright - Holberton School</p>");
      const h = () => {
        let t = l("#count").html() || 0;
        l("button").on("click", () => {
          t++, l("#count").html(`${t} clicks on the button`);
        });
      };
      p.debounce(h, 500), h();
    })();
